...
class MainBranch(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        # All layers are created ONCE here
...
def model(a_vec_size, dim):
    ...
    modified = ModifiedBranch(a_vec_size)(out) #FIRST BRANCH
